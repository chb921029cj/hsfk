            ...
            <el-row style="margin-top:20px">
                <!-- <el-card>
                  ...
                  <table cellpadding="0" cellspacing="0" class="table">
                      ...
                      <tbody>
                        <tr >
                          <th  rowspan="9"> 客户行为检测</th>    
                          <td > 单位名称疑似中介关键词 </td>
                          <td><span>0</span></td>
                        </tr>
                        <tr>
                          <td> 3个月内申请人手机号作为联系人手机号出现的次数过多 </td>
                          <td> 
                        ...
                        <tr>
                          <td> 7天内设备或身份证或手机号申请次数过多 </td>
                          <td>

                          </td>
                        </tr>
                        <tr>
                          <td>  3个月内申请人身份证关联配偶手机数过多  </td>
                          <td>

                          </td>
                        </tr>
                        <tr>
                          <td> 1个月内同一个设备或手机号申请被拒次数过多  </td>
                          <td>
                      ...
                      <tbody>
                        <tr>
                          <th  rowspan="6">多平台借贷申请检测</th>
                          <td>7天内申请人在多个平台申请借款</td>
                          <td>
                            低
                          </td>
                        </tr>
                        <tr>
                          <td> 1个月内申请人在多个平台申请借款 </td>
                          <td>
                            低
                          </td>
                        </tr>  
                        <tr>
                          <td> 3个月内申请人在多个平台申请借款 </td>
                          <td>
                            低
                          </td>
                        </tr>  
                      ...
                      <tbody>
                        <tr>
                          <th  rowspan="6">不良信息扫描</th>
                          <td>申请人信息命中中风险关注名单</td>
                          <td>
                            低
                          </td>
                        </tr>
...
export default {
  ...
  methods: {
    ...
    getTableData(
      ...
      let _this = this;
      httpGetCreditReport(pagesize, npage, startDate, EndDate, phonenume, 4)
        .then(res => {
          let data = res.data;
